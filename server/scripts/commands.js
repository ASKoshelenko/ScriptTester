...
const commands = {
  ...
  '35_delete_orphaned_jpeg_files.sh': `find ${config.sandboxDir}/test_dir -type f -name '*.jpeg' | xargs -I{} sh -c 'pname="$(dirname {})/$(basename -s .jpeg {})"; [ ! -e \${pname}.txt ] && rm \${pname}.jpeg' && echo "Task completed"`,
  ...
  '43_create_files_with_identifiers.sh': `xargs -a ${config.sandboxDir}/hash_file_list -n2 sh -c 'mkdir -p $(dirname $1) && echo $2 > $1' && echo "Task completed"`
};
